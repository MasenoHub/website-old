<x-admin-layout>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 2xl:gap-8">
        ...
        <div class="col-span-1 bg-white rounded-lg px-4 lg:px-8 py-4 lg:py-6">
            ...
            <div class="flex space-x-4 items-end mb-4 lg:mb-6">
                ...
                <span class="text-blue-900 opacity-70 mb-2 whitespace-pre hidden xl:inline-block">/
                    &euro;40.000</span>
            </div>
        ...
        <div class="col-span-1 bg-white rounded-lg px-4 lg:px-8 py-4 lg:py-6">
            ...
            <div class="flex space-x-4 items-end mb-4 lg:mb-6">
                ...
                <span class="text-green-500 text-base mb-2 bg-green-100 border-full  px-3 rounded-full">&#8605;
                    32</span>
            </div>
    ...
    <div class="bg-white rounded-lg px-4 lg:px-8 py-4 lg:py-6 mt-8">
        ...
        <a href="#" class="font-bold text-blue-600 inline-block mt-5 hover:underline">View all
            orders</a>
    </div>
    <!--/ recent orders -->
            ...
            <div class="space-y-4 md:max-w-sm">
                <a href=""
                    ...
                    <div class="flex flex-col items-start  text-sm flex-1">
                        ...
                        <span class="font-bold text-sm text-blue-800 opacity-50">View
                            profile</span>
                    </div>
                    <span
                        class="text-green-500 text-base mb-2 bg-green-100 border-full  px-3 rounded-full">&euro;438</span>
                </a>
                <a href=""
                    class="w-full flex items-center space-x-4 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-60">
                    ...
                    <span
                        class="text-green-500 text-base mb-2 bg-green-100 border-full  px-3 rounded-full">&euro;256</span>
                </a>
                <a href=""
                    class="w-full flex items-center space-x-4 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-60">
                    ...
                    <span
                        class="text-green-500 text-base mb-2 bg-green-100 border-full  px-3 rounded-full">&euro;149</span>
                </a>
            </div>
            <div class="space-y-4 md:max-w-sm">
                <a href=""
                    ...
                    <span
                        class="text-green-500 text-base mb-2 bg-green-100 border-full  px-3 rounded-full">&euro;136</span>
                </a>
                <a href=""
                    class="w-full flex items-center space-x-4 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-60">
                    ...
                    <span
                        class="text-green-500 text-base mb-2 bg-green-100 border-full  px-3 rounded-full">&euro;128</span>
                </a>
                <a href=""
                    class="w-full flex items-center space-x-4 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-60">
                    ...
                    <span
                        class="text-green-500 text-base mb-2 bg-green-100 border-full  px-3 rounded-full">&euro;97</span>
                </a>
            </div>
        </div>
        <a href="#" class="font-bold text-blue-600 inline-block mt-5 hover:underline">View all
